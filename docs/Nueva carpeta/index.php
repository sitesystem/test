...
<head>
	...
	<meta name="theme-color" content="#05530B" />
	<!-- iOS Safari -->
	<meta name="apple-mobile-web-app-status-bar-style" content="#05530B" />
	<link rel="icon" sizes="16x16" href="./upiicsa.png" />
	...
	<style>
	table.dataTable { border-radius: 5px; overflow: hidden; }
	...
	var listar = function()
	{
		...
		var table = $("#tabla").DataTable(
		{
			...
			"createdRow": function( row, data, index )
			{
				...
				$('td', row) . eq ( 5 ) . css ( { 'cursor' : 'default' , 'padding-left' : '13px' , 'padding-bottom' : '10px' , 'vertical-align' : 'middle' } ) .
			...
			[
				...
				// { width: "5px", targets: 17 },
				// { width: "85px", targets: 19 },
				// { width: "40px", targets: 20 },
				// {
					// "searchable": true,
					// "orderable": true,
					// // "targets": 0
